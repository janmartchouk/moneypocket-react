...
export default function SummaryHeaderButton(props) {
    ...
    let color = props.income ? 'purple-500' : 'purple-400'
    ...
    return (
        <div className={`self-around bg-${color} hover:bg-${color} transition ease-in-out duration-200 cursor-pointer shadow-md leading-tight text-white rounded-md inline flex flex-col justify-start align-start summary-${props.type} ${props.mb} summary-headerItem w-full h-auto`}>
